// Implementación del TDA Diccionario con hash cerrado (direccionamiento abierto).
// Usado en todo el TP para almacenar vuelos por código, o mapear conexiones entre aeropuertos.
...
func CrearHash[K comparable, V any]() Diccionario[K, V] {
	...
	d.crearTablaVacia(_CAPACIDAD_MINIMA)
	return d
}
